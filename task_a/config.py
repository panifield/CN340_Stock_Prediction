"""
config.py — งาน A (คู่/คี่)
=========================
ไฟล์ตั้งค่าของงาน A เท่านั้น แก้ที่นี่ไม่กระทบ task_b / task_c
"""
...
# ---------------------------------------------------------------
# 2) กฎการปัดเศษของอาจารย์ (ใช้สร้าง target คู่/คี่)
# ---------------------------------------------------------------
# "ถ้าเศษ > 0.5 ให้ปัดขึ้น"  ->  ROUND_THRESHOLD = 0.5
#   142.50 -> 142 (เพราะ 0.50 ไม่ ">" 0.50)
#   142.70 -> 143
#
...
# ---------------------------------------------------------------
# 3) การแบ่งข้อมูล (ต้องแบ่งตามเวลา ห้าม shuffle)
# ---------------------------------------------------------------
TRAIN_RATIO = 0.70
VAL_RATIO = 0.15
...
# ---------------------------------------------------------------
# 6) การตรวจสอบ Data Leakage
# ---------------------------------------------------------------
# ถ้า feature ตัวไหนมี |correlation| กับ target parity เกินค่านี้
